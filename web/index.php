...
<html>
    ...
    <body class="bgIMG">
        ...
        <main class="afterNav">
            ...
            <br><br><br>
            <p class="center overIMG biggerTXT">Para emprezar, primero debe identificarse.</p>
            <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
            <button type="button" class="logInButton center" id="botonPrincipal">Identificarse</button>
        </main>
    </body>
</html>